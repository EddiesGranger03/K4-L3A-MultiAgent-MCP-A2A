...
class Assessment:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            "primary_issue": self.primary_issue.value if isinstance(self.primary_issue, PrimaryIssue) else str(self.primary_issue),
            "case_status": self.case_status.value if isinstance(self.case_status, CaseStatus) else str(self.case_status),
